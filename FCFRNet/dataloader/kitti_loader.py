...
from dataloader.pose_estimator import get_pose_pnp
...
def load_calib():
    ...
    """
    calib = open("/home/aistudio/FCFRNet/dataloader/calib_cam_to_cam.txt", "r")
...
to_float_tensor = lambda x: to_tensor(x)
    ...
    if split == "train":
        ...
        glob_d = os.path.join(
         ...
         # 'data_depth_velodyne/train/*_sync/proj_depth/velodyne_raw/image_0[2,3]/*.png') 
           'kitti_dc_4k/train/*_sync/proj_depth/velodyne_raw/image_0[2,3]/*.png')
        #'data_depth_velodyne/train/*_sync/proj_depth/velodyne_raw/image_0[2,3]/*.png'
         ...
         #       'data_depth_annotated/train/*_sync/proj_depth/groundtruth/image_0[2,3]/*.png'
          #  )
           ...
           #     return pnew
            ...
            glob_d = os.path.join(
                args.data_folder,
                "kitti_dc_4k/depth_selection/val_selection_cropped/data_depth_dense_new/*.png")
